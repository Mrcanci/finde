> **DOCUMENTO HISTÓRICO. SUPERADO POR v1.6.**
> Conservado como registro. Contiene el circuito de comprobantes de comisión
> mercantil ("Finde NUNCA factura el valor total del tour"), la figura de
> agente de cobro con custodia diferida, el payout de dos condiciones, el
> Nivel 2 de verificación sin régimen tributario ni póliza, y el capital de
> trabajo en cero. Todo eso quedó sin efecto.
> La economía por reserva (margen S/15.21, equilibrio 43 reservas/mes) y el
> modelo de precio neto más markup se mantienen vigentes en v1.6.
