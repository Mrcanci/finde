...
- [ ] **Traducir las plantillas de correo de Supabase, que están en INGLÉS.** La invitación de prueba llegó diciendo "You have been invited to create a user on...". Los usuarios son peruanos y el resto del producto está en español. Se cambian en **Authentication > Emails > Templates**, y conviene hacerlo **junto con reactivar la confirmación de correo**, que es cuando esos textos se empiezan a ver.
